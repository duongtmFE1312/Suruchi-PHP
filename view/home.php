            ...
            <div class="row mb--n28">
                <div class="col-lg-5 col-md-order mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="index.php?pg=shop"><img class="banner__items--thumbnail__img" src="./view/assets/img/banner/1.png" alt="banner-img">
